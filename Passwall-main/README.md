...
```
rm -f passwallx.sh && wget https://raw.githubusercontent.com/zheint/owrt-passwall/refs/heads/main/Passwall-main/passwallx.sh && chmod 777 passwallx.sh && sh passwallx.sh
```
Done !
